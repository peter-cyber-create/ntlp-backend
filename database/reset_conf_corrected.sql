-- DANGER: Drop and recreate 'conf' DB to match server structure
DROP DATABASE IF EXISTS conf;
CREATE DATABASE conf;
USE conf;

-- Registrations (server-compatible structure)
...
-- Contacts (server-compatible structure)
...
-- Abstracts (server-compatible structure)
...
-- Sponsorships (server-compatible structure)
